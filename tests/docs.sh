...
require() {
    ...
    if ! grep -Fq -- "$value" "$file"; then
        echo "${file}にv0.10.0文書の必須記述がありません: ${value}" >&2
        exit 1
    fi
}
...
require README.md "GROWSE_VERSION=v0.12.0"
require README.md "growse:v0.12.0"
...
require SECURITY.md "| 0.12.x | Yes |"
...
require docs/storage-cache-support.md "Growse v0.10.0"
...
echo "v0.12.0文書同期検証成功: README, SECURITY.md, DevTools, Storage / Cache対応表, Form / Fetch / Cookie対応表, CSS対応表, WPT文書, Showcase"
