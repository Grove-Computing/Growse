...
require_file_value Dockerfile "COPY --from=build /src/examples/browser-grade-compat /usr/local/share/growse/examples/browser-grade-compat"
require_file_value Dockerfile "COPY --from=build /src/examples/css-layout-2026 /usr/local/share/growse/examples/css-layout-2026"
...
require_file_value "$ci_workflow" "Docker package (v0.19.0)"
...
require_file_value "$ci_workflow" "growse:v0.19.0"
...
require_file_value "$ci_workflow" "Run Browser-grade Compatibility smoke"
...
require_file_value "$workflow" "Run Browser-grade Compatibility smoke by digest"
require_file_value "$workflow" "Run CSS Layout 2026 smoke by digest"
