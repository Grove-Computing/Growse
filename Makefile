...
.PHONY: test race examples-test v014-conformance-test v015-framework-test v015-visual-test v015-conformance-test v015-security-test v015-regression-test vet staticcheck vulncheck actionlint securityscan installer-test release-test docker-test supply-chain-test developer-security-test skills-test docs-test fmt-check tidy-check quality ci
...
ci: quality securityscan race examples-test v014-conformance-test v015-framework-test v015-visual-test v015-conformance-test v015-security-test v015-regression-test vulncheck installer-test release-test docker-test supply-chain-test developer-security-test skills-test docs-test
