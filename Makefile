...
.PHONY: test race vet staticcheck vulncheck actionlint installer-test release-test docker-test fmt-check tidy-check quality ci
...
ci: quality race vulncheck installer-test release-test docker-test
