...
func appendRenderDiagnostics(metrics RenderMetrics, appendDiagnostic func(devtools.CompatibilityDiagnostic)) {
	for _, counter := range []struct {
		...
		{"resource-queue", "image", "coalesced", "in-flight", metrics.ImageResourceCoalesced},
		{"resource-queue", "image", "canceled", "lifecycle", metrics.ImageResourceCanceled},
		{"resource-queue", "image", "rejected", "bounded", metrics.ImageResourceRejected},
